...
class BarbeariaSystem {
    constructor() {
        ...
        this.barbers = {
            carlos: { name: 'Carlos Silva', phone: '15991642754' },
            joao: { name: 'João Santos', phone: '15991642754' },
            pedro: { name: 'Pedro Lima', phone: '15991642754' },
            rafael: { name: 'Rafael Costa', phone: '15991642754' }
        };
        this.services = {
    ...
    sendWhatsAppConfirmation(appointment) {
        ...
        const whatsappUrl = `https://wa.me/5515991642754?text=${encodeURIComponent(message)}`;
